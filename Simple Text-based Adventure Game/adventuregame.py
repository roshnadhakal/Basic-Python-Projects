...
def start_game():
    ...
    # Player's choice to enter the palace or flee
...
# Function to handle entering the palace
def enter_palace():
...
# Function to handle finding the crown prince's diary
def find_diary():
    print("You find the diary hidden in shadows, revealing a dark truth...")
    
    # Player's choice to confront or hide the truth
...
# Function to handle exploring the private quarters of the palace
...
# Function to handle finding the prince's spirit
def find_prince():
